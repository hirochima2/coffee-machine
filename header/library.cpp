...
string PasswordFunctions::getPassword(){ // neka vrsta pointera
...
void AdminFuncs::AddCoins(int coins[]){
    int choice;
    int amount;
    char answy;
    do{
...
void AdminFuncs::RemoveCoins(int coins[]){
    int choice, amount;
    char answer;
    do{
        system("CLS");
...
void AdminFuncs::ManipulateCoinState(){
    fstream file;
    int choice;
    do{
        file.open("header/coins.txt", ios::in);
